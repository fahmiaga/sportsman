...
export const getContent = (token) => (dispatch) => {
	...
	axios.get(`api/content/all`, config)
		.then((res) => {
...
export const getContentById = (token, id) => (dispatch) => {
	...
	axios.get(`/api/content/${id}`, config)
		.then((res) => {
			console.log("coba", res);
			dispatch({
...
export const postContent = (token, input) => (dispatch) => {
	...
	axios.post(`api/admin/content`, input, config)
		.then((res) => {
			console.log("coba", res);
			dispatch({
				type: POST_CONTENT,
...
export const putContent = (token, input, id) => (dispatch) => {
	...
	axios.put(`/api/admin/content/${id}`, input, config)
		.then((res) => {
...
export const deleteContent = (token, id) => (dispatch) => {
	...
	axios.delete(`api/admin/content/${id}`, config)
		.then((res) => {
			console.log("coba", res);
			dispatch({
				type: DELETE_CONTENT,
