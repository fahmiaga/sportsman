				...
				>
					<div className="about__content__wrapper">
						<div className="about__content__wrapper__up">
							...
							<p>
								...
								There is no hesitation to join
								with us. Regret always comes to
								the end.
							</p>
						</div>
					...
					<div className="about__content__bottom">
						<div className="about__content__bottom__text">
							<h3>ABOUT OUR GYM</h3>
							<p>
								A gymnasium, also known as a
								gym, is a covered location for
								athletics. The word is derived
								from the ancient Greek
								gymnasium. They are commonly
								found in athletic and fitness
								centers, and as activity and
								learning spaces in educational
								institutions. "Gym" is also
								slang for "fitness center",
								which is often an area for
								indoor recreation. A gym may be
								open air as well. A gym is a
								place with a number of
								equipments and machines used by
								the people to do exercises.
							</p>
							<p>
								A gymnasium, also known as a
								gym, is a covered location for
