...
import { Card, CardImg, CardText, CardBody, CardTitle, Row, Col, Container, Button, Modal, ModalHeader, ModalBody, ModalFooter } from 'reactstrap';
			...
			<Container className='mt-4 mb-4'>
				<Row>
					{data.result.map((video, i) => (
						<Col md='3' className='mb-3' onClick={toggle} style={{ cursor: 'pointer' }} value={video.url} key={i}>
							<Card>
								<CardImg top width='100%' src={`http://img.youtube.com/vi/${video.url}/0.jpg`} alt='Card image cap' />
								<CardBody>
