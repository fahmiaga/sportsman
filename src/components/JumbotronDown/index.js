...
const JumbotronDown = () => {
	return (
		<>
			<div className='jumbotron-down' style={{ backgroundImage: `url(${jumbotronImage})` }}>
				...
				<p>By signing up for Sportsman, you agree to the Terms of Service. View our Privacy Policy.</p>
			</div>
